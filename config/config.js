...
module.exports = {
  robot: {
    ...
    naviPort: Number(process.env.ROBOT_NAVI_PORT || 19206),
    otherPort: Number(process.env.ROBOT_OTHER_API_PORT || 19210),
    ConfigurationPort: Number(process.env.ROBOT_Configuration_PORT || 19207)
  },
  server: {
